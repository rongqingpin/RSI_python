class BinarySearchTree:
    ...
    def _put(self,key,val,currentNode):
        ...
        if key < currentNode.key:
            ...
            currentNode.successor = currentNode.findSuccessor()
        else:
            currentNode.replaceNodeData(key, val, currentNode.leftChild, currentNode.rightChild, currentNode.parent, currentNode.successor)
...
def inorder(tree):
    if tree != None:
        ...
        inext = istart.successor
        while inext:
            print(inext.payload)
            inext = inext.successor
...
# print(mytree.root.leftChild.leftChild.successor.payload)
# print(mytree.root.leftChild.successor.payload)
# print(mytree.root.leftChild.rightChild.successor.payload)
# print(mytree.root.successor.payload)
# print(mytree.root.rightChild.leftChild.successor.payload)
# print(mytree.root.rightChild.successor.payload)
inorder(mytree)
